;(function () {
  ...
  class ScrollSlider {
    constructor(element, config) {
      ...
      if (
        ...
        Object.getPrototypeOf(this) !== ScrollSlider.prototype
      ) {
  ...
  function _init() {
    // Wrapper elements
    scrollSlider.horizScrolWrap =
      scrollSlider.container.querySelector(".scroll-slides")
    scrollSlider.slides =
      scrollSlider.horizScrolWrap.querySelectorAll(".scroll-slide")
    scrollSlider.sticky =
      scrollSlider.container.querySelector(".scroll-wrapper")
  ...
  function _scrollHandler() {
    ...
    let distRatio =
      scrollSlider.sticky.offsetTop / (scrollSlider.scrollWidth - 512)
  ...
  function _resolveContainer(container) {
    if (container) {
      if (typeof container === "string") {
        ...
        console.log(
          'ScrollSlider: invalid container "' + container + '" provided.'
        )
  ...
  function _repositionSlider() {
    scrollSlider.horizScrolWrap.style.paddingLeft = `${
      window.innerWidth / 2 - scrollSlider.slides[0].offsetWidth / 2
    }px`
